...
def query():
    ...
    #return link.id
##    c = db.execute("select * from links where submitter_id = 62443 order by submitted_time") #by defualt sorting take place in ascending order
##    t = []
##    for l in c:
##        link = Link(*l)
##        t.append(link.id)
##    return t
##    c = db.execute("select * from links where submitter_id = 62443 order by submitted_time asc") #specify ascending order
##    t = []
##    for l in c:
##        link = Link(*l)
##        t.append(link.id)
...
##    c = db.execute("select * from links where submitter_id = 62443 order by submitted_time desc") #sepicf descending order
##    t = []
##    for l in c:
##        link = Link(*l)
##        t.append(link.id)
...
#select link.* form link,user where link.user_id = user.id and user.name="spez"
##
